...
- Results artifact retention expiry recorded by GitHub: `2026-11-27T18:54:06Z`
...
No individual task or treatment was retried. Losing and failed transcripts, stderr/stdout, scorer outputs, patches, status, metadata, and workspaces remain in the exact raw Actions artifact.
...
The exact download of Actions artifact `9720290597` was independently inspected during T254. Its SHA-256 is `dcad221a52e110a34198109ac31bfe164e2ac47610e78b83b9d98f17102c3218`, exactly matching GitHub's recorded artifact digest.
...
GitHub Actions artifact retention is finite. The canonical manifest records the artifact ID, exact SHA-256, run ID, source revision, and validation findings so expiration cannot be mistaken for missing provenance, but the raw binary evidence is only directly downloadable while GitHub retains artifact `9720290597`.

## Raw evidence

The raw publication surface is Actions artifact `9720290597` from canonical workflow run `33269484561`. Download that exact artifact and verify:

```sh
echo 'dcad221a52e110a34198109ac31bfe164e2ac47610e78b83b9d98f17102c3218  raw-evidence.zip' | sha256sum -c -
unzip -l raw-evidence.zip
```
